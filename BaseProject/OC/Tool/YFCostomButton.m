...
- (void)initialization
{
    ...
    self.buttonImagePosition = YFCustomButtonImagePositionLeft;//默认布局
}
...
- (void)layoutSubviews
{
    ...
    //默认布局不用处理
    if (self.buttonImagePosition == YFCustomButtonImagePositionLeft) {
        return;
    }
    //content的实际size
    ...
    //垂直布局
    if (self.buttonImagePosition == YFCustomButtonImagePositionTop || self.buttonImagePosition == YFCustomButtonImagePositionBottom) {
        ...
        if (self.buttonImagePosition == YFCustomButtonImagePositionTop) {//重置Y坐标
            switch (self.contentVerticalAlignment) {
                ...
                case UIControlContentVerticalAlignmentCenter: {
                    ...
                    CGFloat minY = CGFloatGetCenter(contentSize.height, contentHeight) + self.contentEdgeInsets.top + self.imageEdgeInsets.bottom;
                    imageFrame = CGRectSetY(imageFrame, minY + self.imageEdgeInsets.top + self.imageEdgeInsets.bottom);
                    titleFrame = CGRectSetY(titleFrame, CGRectGetMaxY(imageFrame)+2);
                }
                    break;
    ...
    } else if (self.buttonImagePosition == YFCustomButtonImagePositionRight) {//水平布局
...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    switch (self.buttonImagePosition) {
        case YFCustomButtonImagePositionTop:
        case YFCustomButtonImagePositionBottom: {
        ...
        case YFCustomButtonImagePositionLeft:
        case YFCustomButtonImagePositionRight: {
            if (self.buttonImagePosition == YFCustomButtonImagePositionLeft && self.titleLabel.numberOfLines == 1) {
...
- (void)setButtonImagePosition:(YFCustomButtonImagePosition)buttonImagePosition
{
